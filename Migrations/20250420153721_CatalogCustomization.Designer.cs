...
namespace Saas.Migrations
{
    ...
    [Migration("20250420153721_CatalogCustomization")]
    partial class CatalogCustomization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Saas.Models.CatalogCustomization", b =>
                {
                    b.Property<int>("CatalogCustomizationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("CatalogCustomizationId"));
                    ...
                    b.HasKey("CatalogCustomizationId");

                    b.HasIndex("CatalogId");

                    b.ToTable("CatalogCustomizations");
                });
            ...
            modelBuilder.Entity("Saas.Models.Template", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("CustomizableAreas")
                        .IsRequired()
                        .HasColumnType("json");

                    b.Property<string>("DefaultCss")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Saas.Models.Catalog", b =>
                {
                    b.HasOne("Saas.Models.Template", "Template")
                        .WithMany()
